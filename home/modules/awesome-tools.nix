...
# ---------------------------------------------------------------------------
{
  ...
  '';
  nixOutputMonitorCompat = pkgs.writeShellScriptBin "nix-output-monitor" ''
    exec ${pkgs.nix-output-monitor}/bin/nom "$@"
  '';
  deployRsCompat = pkgs.writeShellScriptBin "deploy-rs" ''
    exec ${pkgs.deploy-rs}/bin/deploy "$@"
  '';
  televisionCompat = pkgs.writeShellScriptBin "television" ''
